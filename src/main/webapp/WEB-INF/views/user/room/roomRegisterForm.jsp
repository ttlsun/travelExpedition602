...
<div>
	...
	<table border="1" class="table table-bordered">
		...
		<tr>
			<td><label for="name"><span class="redFont"> * </span> 객실 명칭 </label></td>
			<td>
		...
		<tr>
			<td><label for="multipleUpdateFile"> 객실 상세 이미지<br><small>(여러 장 가능)</small> </label> </td>
			<td colspan="3">
		...
		<tr>
			<td><label for="contents"><span class="redFont"> * </span> 객실 상세 소개글 </label></td>
			<td colspan="3">
