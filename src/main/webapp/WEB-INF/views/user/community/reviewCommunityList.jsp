...
$(document).ready(function() {
	...
	//메타태그 설정.
	$("#metaTitle").attr("content", "방문한 후기 리스트");
	$("#metaDescription").attr("content", "방문한 캠핑/글램핑, 방문한 관광지 후기 리스트");
	$("#metaKeywords").attr("content", "#리뷰 #캠핑/글램핑, #관광지, #후기");
	
});

//상세페이지로 이동 버튼
function goDetail(num) {
	location.href= "${contextPath}/communityDetail.do?num=" + num + "&pageNumber=" + ${pageInfo.pageNumber}+"&type=2";
}
