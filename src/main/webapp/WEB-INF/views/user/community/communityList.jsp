...
//등록페이지이동 버튼
function goRegister() {
	location.href= "${contextPath}/communityRegister.do?reviewtype=03&type=1";
}
...
function goDetail(num) {
	...
	location.href= "${contextPath}/communityDetail.do?num=" + num + "&pageNumber=" + pageNumber+"&type=1";
}
...
<article>
<div>
	<header><h2 align="center" class="text-primary"> 모든 후기 리스트 화면</h2></header>
