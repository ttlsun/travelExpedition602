	...
	<table class="table table-bordered">
		...
		<tr>
			<td colspan="4" align="center" style="border: none; padding-bottom: 20px;">
				<img src="${fileImg}/${tourbean.imgurl}" alt="" title="" width="60%">
			</td>
		</tr>
		<tr>
			<td colspan="4" align="center" style="border: none; padding-bottom: 20px;">
		...
		<tr>
			<td>할인가</td>
			<td>${tourbean.discount }</td>
			<td>가격</td>
			<td>${tourbean.price }</td>
		</tr>
		<tr>
			<td>관광지 연락처</td>
			<td colspan="3">
		...
		<tr>
			...
			<td>
				<span class="text-primary" style="font-size: 15px;">
				<c:set var="fullAddr" value="${tourbean.address1} ${tourbean.address2} ${tourbean.address3} ${tourbean.address4}"/>
				${fullAddr }
				</span>	
			</td>
			<th>
