...
<div>
	...
	<table class="table table-bordered">
		...
		<tr>
			<td colspan="2" style="border: none;"> 캠핑/글램핑 후기</td>
		...
		<tr>
			...
			<td colspan="3" style="border: none; text-align:end;" width="30%">
				<button type="button" class="btn outline-secondary" onclick="goRecommend(1)">
					추천
			    ...
			    <button type="button" class="btn outline-secondary" onclick="goRecommend(2)">
	           		비추천
				...
				<button type="button" class="btn outline-secondary" onclick="goSteamed()">
	...
	<div class="marginPadding10">
		...
		<legend class="textAlignLeft">후기 댓글</legend>
			<div class="form-group">
				...
				<div align="left">
					<button type="button" class="btn btn-outline-secondary" onclick="return rippleBtn()">
			...
			<caption>후기 댓글 목록</caption>
				...
				<tr>
					...
					<td style="border: none;">
						<input type="hidden" name="rippleNo" value="">
						댓글 내용
					</td>
					<td style="border: none;">
						<input type="button" class="btn btn-primary" value="X" onclick="return goDelete()">
					</td>
				</tr>
			</table>
		</div>
