...
$(document).ready(function() {
	...
	//메타태그 설정.
	$("#metaTitle").attr("content", "관리자 키워드 태그관리  등록");
	$("#metaDescription").attr("content", "관리자 키워드 태그관리 등록");
...
<article>
<div>
	<header><h2 align="center" class="text-primary"> 키워드 태그관리 등록 </h2></header>
	<form:form commandName="keyword" name="myForm" action="keywordRegister.ad" method="post" class="form-horizontal">
			...
			<tr>
				...
				<td>
					<select name="acode" id="acode" class="form-control">
						<option value="선택"  <c:if test="${keyword.acode eq '선택'}"> selected="selected" </c:if>>선택</option>
